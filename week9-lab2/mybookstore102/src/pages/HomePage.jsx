...
const HomePage = () => {
  ...
  // Sample featured books to display on the homepage. Fields match the shape
  // expected by `BookCard` (id, coverImage, isNew, discount, category, title,
  // author, rating, reviews, originalPrice, price).
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-viridian-600 to-green-700 text-white">
        <div className="bg-green-600 container mx-auto px-4 py-24">
